<div class="vg-element vg-full vg-box-shadow">
    <div class="vg-element vg-full vg-box-shadow">
        <div class="vg-wrap vg-element vg-half vg-left vg-no-space-top">
            ...
            <div class="vg-element vg-full vg-left">
                <span class="vg-text vg-firm-color5"></span><span class="vg-subheader"><?= $this->translate[$row][1] ?></span>
            </div>
                    ...
                    <?php if (is_int($key)): ?>
                        <label class="vg-element vg-full vg-center vg-left vg-space-between">
                            ...
                            <input type="radio" name="<?=$row?>" class="vg-input vg-half"
                                   ...
                                   elseif (!isset($this->data[$row]) && $this->foreignData[$row]['default'] == $item) echo
                                   'checked' ?> value="<?=$key?>">
                        </label>
                    <?php endif; ?>
                <?php endforeach; ?>
